...
\begin{center}
\includegraphics[width=\textwidth]{data/Aleeza-daptation-probably-biased-female-speaker-results.png}
\includegraphics[width=\textwidth]{data/Aleeza-daptation-probably-biased-male-speaker-results.png}
\includegraphics[width=\textwidth]{data/Aleeza-Adaptation-bare-biased-female-speaker-results.png}
\includegraphics[width=\textwidth]{data/Aleeza-Adaptation-bare-biased-male-speaker-results.png}
\vspace{2em}
\end{center}
